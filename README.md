# lib-eshia-scraper
أداة خفيفة مخصّصة لاستخراج النص الكامل لأحد الكتب من صفحات القارئ من موقع [lib.eshia.ir](https://lib.eshia.ir/)، وذلك عبر جمع المحتوى النصي من الصفحات وعرضه بصيغة موحّدة قابلة للقراءة أو المعالجة اللاحقة.
## طريقة الاستخدام
...
```
## المساهمة
**ملاحظة:** يهدف هذا المشروع إلى خدمة المجتمع الشيعي. يمكن المساهمة بعدة طرق:
